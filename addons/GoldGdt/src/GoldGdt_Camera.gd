...
func _process(delta_) -> void:
	...
	if Input.is_action_pressed("pm_moveleft"):
		cam_tween.tween_property($"Arm/Arm Anchor/Camera Recoil/Camera Shake/Camera", "rotation:z", 0.1, 0.1)
	elif Input.is_action_pressed("pm_moveright"):
		cam_tween.tween_property($"Arm/Arm Anchor/Camera Recoil/Camera Shake/Camera", "rotation:z", -0.1, 0.1)
	else:
		cam_tween.tween_property($"Arm/Arm Anchor/Camera Recoil/Camera Shake/Camera", "rotation:z", 0, 0.1)
